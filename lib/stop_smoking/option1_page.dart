...
class _Option1PageState extends State<Option1Page> {
  ...
  void _startOption1Algorithm() async {
    ...
    String method = 'Option 1: 15 % weniger jeden Tag';

    // Berechnet die Reduzierung (max. 51 Tage)
    for (int day = 0; day < 51; day++) {
      int cigarettesToReduce = (totalCigarettes * 0.15).round();
      ...
      pw.Page(
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Text(
                  'Du rauchst $initialCigarettes Zigaretten täglich. Hier ist dein Plan, dies schnell und hart zu beenden:'),
              pw.SizedBox(height: 20),
              pw.TableHelper.fromTextArray(
                headers: ['Tag', 'Morgens', 'Tagsüber', 'Abends'],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Schnell & Hart')),
      body: _isCalculating
